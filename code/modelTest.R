...
#testResult$gxnaGbm = testModel(class = GSetModel, exprSets = gxnaSepSets[1:500], modelType = "gbm")
#testResult$topGenesGbm = testModel(class = GSetModel, exprSets = topgeneSets[1:500], modelType = "gbm")
